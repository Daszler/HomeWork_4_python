...
n_set = set(random.randint(1, 20) for _ in range(int(input('Введите кол-во эл-ов первого множества: '))))
m_set = set(random.randint(1, 20) for _ in range(int(input('Введите кол-во эл-ов второго множества: '))))
print(n_set)
print(m_set)
